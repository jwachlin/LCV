...
#define MOTOR_ENABLE_GPIO			IOPORT_CREATE_PIN(IOPORT_PORTA, 0)
...
#define MOTOR_READY_GPIO			IOPORT_CREATE_PIN(IOPORT_PORTA, 1)
...
#define INPUT_PUSHBUTTON_GPIO				IOPORT_CREATE_PIN(IOPORT_PORTA, 12)
#define INPUT_ENABLE_GPIO					IOPORT_CREATE_PIN(IOPORT_PORTB, 11)
...
#define FLOW_SENSOR_ANALOG_GPIO				IOPORT_CREATE_PIN(IOPORT_PORTB, 2)
#define FLOW_SENSOR_ANALOG_GPIO_FLAGS		(IOPORT_MODE_MUX_B)
...
// Alarms
#define BUZZER_GPIO						IOPORT_CREATE_PIN(IOPORT_PORTB, 22)
#define BUZZER_GPIO_ACTIVE_LEVEL		IOPORT_PIN_LEVEL_HIGH
#define WATCHDOG_GPIO					IOPORT_CREATE_PIN(IOPORT_PORTA, 21)
#define WATCHDOG_GPIO_ACTIVE_LEVEL		IOPORT_PIN_LEVEL_HIGH

// Power monitoring
#define POWER_MONITOR_GPIO				IOPORT_CREATE_PIN(IOPORT_PORTA, 28)

// Voltage reference
#define VREFA_GPIO						IOPORT_CREATE_PIN(IOPORT_PORTA, 3)
#define VREFA_GPIO_FLAGS				(IOPORT_MODE_MUX_C)
